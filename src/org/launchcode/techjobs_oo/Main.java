...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Job job2 = new Job("Web Developer", new Employer("LaunchCode"), new Location("St. Louis"),
        ...
        Job job4 = new Job("Line Cook", new Employer("Bob Evans"), new Location("University City"),
                new PositionType("Manager"), new CoreCompetency(""));
